...
void disable_callback(GLFWwindow* window, double xpos, double ypos);
...
int main() 
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (isEnable) {
			...
			glfwSetCursorPosCallback(window, disable_callback);
			glfwSetScrollCallback(window, disable_callback);
		}
